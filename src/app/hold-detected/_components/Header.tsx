...
export const Header: React.FC = () => {
  ...
  className="text-white px-6 py-3 md:px-12 md:py-4
             bg-[linear-gradient(135deg,_rgb(243,156,18)_0%,_rgb(230,126,34)_100%)]"
>
      ...
      <div className="flex justify-between items-center mb-2">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <h1 className="font-bold text-lg md:text-2xl">Multiple Returns</h1>
        </div>
      ...
      <div className="flex justify-between items-center w-full px-4 py-2 rounded-md bg-[rgba(255,255,255,0.15)]">
        <span className="text-sm md:text-base font-medium text-white"> ⚠️ Hold Item Detected</span>
