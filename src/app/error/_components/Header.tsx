...
export const Header: React.FC = () => {
  return (
    <header className="bg-[linear-gradient(135deg,_rgb(231,76,60)_0%,_rgb(192,57,43)_100%)] text-white px-6 py-3 md:px-12 md:py-4">
      {/* Top row: Logo + Title and Help button */}
      <div className="flex justify-between items-center mb-2">
        {/* Left: Logo + Title */}
        <div className="flex items-center gap-2 md:gap-4">
          <div className="bg-white rounded p-1">📚</div>
          <h1 className="font-bold text-lg md:text-2xl">Error Detected</h1>
        </div>
      ...
      <div className="flex justify-between items-center w-full px-4 py-2 rounded-md bg-[rgba(255,255,255,0.15)]">
        <span className="text-sm md:text-base font-medium text-white">❌ Processing Error</span>
